...
<body>
 ...
 <div class="modal fade" id="exampleModal" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary">Contiune</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="jumbotron text-center ">
        <h1><span class="text-primary">Display</span> Series </h1>
    </div>
...
<div id="Series"> 
      ...
      while ($row = $result->fetch_assoc()) {
        ...
        echo "<tr><td><button type='button' class='btn select' data-id='" . $row['SeriesID'] . "'>Select <i class='fas fa-angle-right fa-1x'> </i></button> </td>
