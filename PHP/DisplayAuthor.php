...
<div class="modal fade" id="exampleModal" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    ...
    <div class="jumbotron text-center ">
        <h1><span class="text-primary">Display</span> Author </h1>
    </div>
<div class="container author2">
<div id ="Author" >
    ...
    <script>
        $(document).ready(function() {
         ...
         //   $('.select').click(function() {
                ...
                $.ajax({
                    type: "post",
                    url: 'editfiles/ajaxfileAuthor.php',
        ...
        $(document).on('click','.editpage',function(){
                ...
                var id = $(this).data('id');
               var name2= authorform.elements["Name"].value;
              var  url= authorform.elements["URL"].value;
              var location= authorform.elements["Location"].value;
              var  details= authorform.elements["Details"].value;
              

                $.ajax({
                    type: "post",
                    url: 'editfiles/editAuthor.php',
                    // url: 'deletefiles/EditSeries.php',
                    data: {
                        userid: id,
                        name2: name2,
        ...
        $(document).on('click', '.delete', function(){
            var id = $(this).data('id');
                ...
                $.ajax({
                    type: "post",
                    url: 'editfiles/deleteAuthor.php',
                    // url: 'deletefiles/EditSeries.php',
                    data: {
                        userid: id
