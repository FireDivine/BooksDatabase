...
<div class="jumbotron">
    <h1 class="title text-center">Add New Author</h1>
  </div>
    ...
    <!-- <div class=" box"> -->
        ...
        <form method="POST">
            ...
            <label>Details</label>
                ...
                <input type="textarea" name="Details"  class="form-control" required="">
                
            </div>
            <div class="form-group">
                <button type="submit" class=" btn btn-primary form-control" value="Add Author" name="submit">Add Author</button>
            </div>
    <!-- </div> -->
    </form>
    </div>
...
$lolly = "Select max(`AuthorID`) as max from `author`";
$result = $conn->query($lolly);
while ($row = $result->fetch_assoc()) {
 
    echo $row['max']++."<br>";
   
    $sql = "INSERT INTO `author` (`AuthorID`, `AuthorName`, `AURL`,`ALocation`,`ADetails`) VALUES (".$row['max' ]++.",'$Name', '$url', '$location', '$details') ";
    // INSERT INTO `author` (`AuthorID`, `AuthorName`, `AURL`, `ALocation`, `ADetails`) VALUES ('', NULL, NULL, NULL, NULL) 
