...
<body>
    ...
    <!-- Jumbotron -->
    <div class="jumbotron">
        <h1 class="title text-center">Add New <span class="text-primary ">Testing</span>Books</h1>
    </div>
    <div class="container series2">
    <div id="Series">
        <?php
        ...
        echo "<table class='table table-striped table-dark table-hover table-responsive-sm  serirestable'>
      ...
      <tr>
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<tr><td><button type='button' class='btn select' data-id='" . $row['SeriesID'] . "'>Select <i class='fas fa-angle-right fa-1x'> </i></button>
         </td>
    ...
    <!-- <div class="container">
        <button class="btn btn-primary edit" value="edit">Edit Entry</button>
        <button class="btn btn-primary delete" value="delete" data-toggle="modal" data-target="#exampleModal">Delete Entry</button>
    ...
    <script>
        $(document).ready(function() {
         ...
         //   $('.select').click(function() {
                ...
                $.ajax({
                    type: "post",
                    url: 'editfiles/ajaxfileSeries.php',
        ...
        $(document).on('click','.editpage',function(){
                ...
                var id = $(this).data('id');
               var name2= seriesform.elements["namee"].value;
              var  tol= seriesform.elements["totale"].value;

                $.ajax({
                    type: "post",
                    url: 'editfiles/editSeries.php',
                    // url: 'deletefiles/EditSeries.php',
                    data: {
                        userid: id,
                        name2: name2,
        ...
        $(document).on('click', '.delete', function(){
            var id = $(this).data('id');
                ...
                $.ajax({
                    type: "post",
                    url: 'editfiles/deleteSeries.php',
                    // url: 'deletefiles/EditSeries.php',
                    data: {
                        userid: id
