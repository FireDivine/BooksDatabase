...
<!-- Jumbotron -->
  <div class="jumbotron">
    <h1 class="title text-center">Add New<span class="text-primary"> Publisher</span></h1>
  </div>
  <div class="container">
        ...
        <form method="POST">
            ...
            <div class="form-group">
                <button type="submit" class=" btn btn-primary form-control"  value="Add Publisher" name="submit">Add Publisher </button>
            </div>
...
$lolly = "Select max(`PublisherID`) as max from `publisher`";
$result = $conn->query($lolly);
while ($row = $result->fetch_assoc()) {
 
    echo $row['max']++."<br>";
   
    $sql = "INSERT INTO `publisher` (`PublisherID`, `PName`, `Pyear`, `Planguage`, `muitple`) VALUES (".$row['max' ]++.",'$Name',null, '$Language',null) ";
    //INSERT INTO `publisher` (`PublisherID`, `PName`, `Pyear`, `Planguage`, `muitple`) VALUES ('', NULL, NULL, NULL, NULL)  
